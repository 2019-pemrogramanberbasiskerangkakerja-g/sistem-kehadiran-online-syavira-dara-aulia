...
exports.tambahkls = function(req, res){
    res.render('daftarkls.ejs');
}

exports.tambahjdwl = function(req, res){
    res.render('daftarjadwal.ejs');
}

exports.tambahpsrt = function(req, res){
    res.render('daftarpeserta.ejs');
}
