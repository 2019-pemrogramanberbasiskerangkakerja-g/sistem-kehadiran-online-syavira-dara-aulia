...
INSERT INTO `jadwal_kuliah` (`id_jadwal`, `id_pertemuan`, `fk_kode_mk`, `hari`, `jam_masuk`, `jam_pulang`, `ruang`) VALUES
('001', 0, 'IF184605', 'senin', '00:09:55', '00:12:35', '107a');
...
INSERT INTO `mata_kuliah` (`kode_mk`, `id_pertemuan`, `mata_kuliah`, `kelas`, `nama_dosen`) VALUES
('IF184605', 0, 'Pemrograman Berbasis Kerangka Kerja', 'G', 'Ridho Rahman Hariadi, S.Kom., M.Sc.	'),
('IF184606', 0, 'Pemrograman Berbasis Kerangka Kerja', 'H', 'Ridho Rahman Hariadi, S.Kom., M.Sc.	');
