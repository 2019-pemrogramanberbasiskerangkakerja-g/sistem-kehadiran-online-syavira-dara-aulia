...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Bulan Mei 2019 pada 11.07
...
(5, 4, 1, '2019-05-13 10:00:00', '2019-05-13 12:30:00');
...
--
-- AUTO_INCREMENT untuk tabel `log_absen`
--
ALTER TABLE `log_absen`
...
--
ALTER TABLE `mata_kuliah`
  MODIFY `kode_matkul` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Ketidakleluasaan untuk tabel `log_absen`
--
ALTER TABLE `log_absen`
